...
public class SourceInfoTest {
    ...
    void schemaIsCorrect() {
        final Schema schema = SchemaBuilder.struct()
                ...
                .field("txName", Schema.OPTIONAL_STRING_SCHEMA)
    ...
    @Test
    void transactionNameIsExposedForRpsSelfWrittenTransactionFiltering() {
        source.setTransactionName("RPS_ORIGIN");

        assertThat(source.struct().getString("txName")).isEqualTo("RPS_ORIGIN");
    }
}
